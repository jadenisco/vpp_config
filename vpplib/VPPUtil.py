...
ubuntu_pkgs = {'release': ['vpp', 'vpp-plugin-core', 'vpp-plugin-dpdk', 'python3-vpp-api',
                           'vpp-dbg', 'vpp-dev'],
               'master': ['vpp', 'vpp-plugin-core', 'vpp-plugin-dpdk', 'python3-vpp-api',
                          'vpp-dbg', 'vpp-dev']}
...
class VPPUtil(object):
    ...
    def _install_vpp_ubuntu(self, node, branch, ubuntu_version='xenial'):
        ...
        reps += '{}/ubuntu {} main\n'.format(branch, ubuntu_version.lower().split()[0])
